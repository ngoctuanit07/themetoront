<?php
class Sns_Toronto_Block_Adminhtml_System_Config_Form_Field_AddCustomMenu extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    public function __construct()
    {
        if (!$this->getTemplate()) {
            $this->setTemplate('sns/toronto/system/config/form/field/array.phtml');
        }
        ...
        $this->addColumn('position', array(
            ...
            'style' => 'width:100px',
            'type' => 'select',
            'values' => Mage::getModel('toronto/system_config_source_listCategoryLv0')->toOptionArray()
        ));
        ...
        $this->addColumn('block_id', array(
            ...
            'style' => 'width:100px',
            'type' => 'select',
            'values' => Mage::getModel('toronto/system_config_source_listStaticBlock')->toOptionArray()
        ));
