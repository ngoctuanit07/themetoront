<?php
class Sns_Toronto_Block_Adminhtml_System_Config_Form_Field_Pattern extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element) {
		...
		foreach($options as $option) {
			...
			$patternUrl = Mage::getBaseUrl('skin') . '/frontend/sns_toronto/default/images/pattern/' . $option['value'] . '.png';
